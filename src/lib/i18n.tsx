...
const en: Dict = {
  ...
  "prog.share_tag": "Courtship · find your tennis partner in Uppsala 🎾",
  ...
  "prog.empty_title": "Your season starts here",
  "prog.empty_sub": "Play and log a game to light up your streak, ranks and passport.",
  ...
  "lb.sub": "This month across Uppsala & Stockholm — resets on the 1st.",
  "lb.active": "King / Queen of the Court",
  "lb.rescuer": "Top Rescuer",
  "lb.host": "Top Host",
  "lb.you": "you",
  "lb.kudos": "Give kudos",
  "lb.empty": "No games logged this month yet — be the first 🎾",
...
const sv: Dict = {
  ...
  "prog.share_tag": "Courtship · hitta din tennispartner i Uppsala 🎾",
  ...
  "prog.empty_title": "Din säsong börjar här",
  "prog.empty_sub": "Spela och logga en match för att tända din svit, ranker och pass.",
  ...
  "lb.title": "Topplistor",
  "lb.sub": "Den här månaden i Uppsala & Stockholm — nollställs den 1:a.",
  "lb.active": "Banans kung / drottning",
  "lb.rescuer": "Månadens räddare",
  "lb.host": "Månadens värd",
  "lb.you": "du",
  "lb.kudos": "Ge kudos",
  "lb.empty": "Inga matcher loggade än denna månad — bli först 🎾",
